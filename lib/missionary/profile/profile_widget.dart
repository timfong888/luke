...
class _ProfileWidgetState extends State<ProfileWidget>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.textController4?.text = '[life-verse]';
        }));
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ToggleIcon(
                  onPressed: () async {
                    setState(() => FFAppState().localEditProfileOn =
                        !FFAppState().localEditProfileOn);
                  },
                  value: FFAppState().localEditProfileOn,
                  onIcon: Icon(
                    Icons.toggle_on,
                    color: Color(0xFF40B3EC),
                    size: 25.0,
                  ),
                  offIcon: Icon(
                    Icons.toggle_off,
                ...
                if (FFAppState().localEditProfileOn == true)
                  Expanded(
                              ...
                              TextFormField(
                                controller: _model.textController3 ??=
                                  ...
                                  text: valueOrDefault<String>(
                                    editProfileUsersRecord.missionStatement,
                                    'Encourage and Support Missionaries',
                                  ),
                                ),
                                autofocus: true,
                                obscureText: false,
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  final usersUpdateData = createUsersRecordData(
                                    ...
                                    lifeVerse: _model.textController4.text,
                                  );
                ...
                if (FFAppState().localEditProfileOn == false)
                  Expanded(
                    child: Container(
                      width: MediaQuery.of(context).size.width * 0.9,
